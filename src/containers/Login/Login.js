...
import LogoImg from '../../static/assets/layouts/layout/img/ccai_logo_login.png'
...
class Login extends BaseContainer {
  ...
  render() {
    ...
    return <div className="login">
      ...
      <div className="logo">
        <a>
          <img width="300" height="80" src={LogoImg} alt="" />
        </a>
      </div>
      {/* <!-- END LOGO --> */}
      {/* <!-- BEGIN LOGIN --> */}
      ...
      <div className="copyright"> 2021 © Moduit. </div>
